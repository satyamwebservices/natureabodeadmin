<div class="col-md-12 mb-3">
    <div class="row">
        <div class="box-header">
            <h2>Add New Discount Section...</h2>
        </div>
    </div>
</div>  
...
<form action="" method="post" class="form-horizontal" enctype="multipart/form-data" />
    ...
    <div class="row mb-3">
        <label for="simpleinput" class="col-md-2 pl-1 col-form-label">Offer Text:</label>
        <div class="col-md-10">
            <input type="text" name="offertxt" id="simpleinput" class="form-control">
        </div>
    </div> 

    <div class="row mb-3">
        <label for="simpleinput" class="col-md-2 pl-1 col-form-label">Discount Code:</label>
        <div class="col-md-10">
            <input type="text" name="discountcode" id="simpleinput" class="form-control">
        </div>
    </div> 
