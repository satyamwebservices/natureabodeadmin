...
<div class="">
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);"><?php echo $username; ?></a></li>
                                <li class="breadcrumb-item"><a href="<?php echo base_url('user/logout');?>">Logout</a></li>
    ...
    <footer class="footer">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <script>document.write(new Date().getFullYear())</script> © Hyper - Vineet Sharma
                </div>
                <div class="col-md-6">
